...
void OpenGLLayer::onAttach()
{
    ...
    _vbo->unbind();
    auto indices  = std::span<std::uint32_t> {assets::quadIndices.data(), assets::quadIndices.size()};
    ...
    _texture = moci::RenderFactory::makeTexture2D("src/app/sandbox3D/assets/textures/skybox/back.jpg");
