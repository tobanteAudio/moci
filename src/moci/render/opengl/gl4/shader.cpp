...
void OpenGLShader::setInts(std::string const& name, int count, int* values)
{
...
void OpenGLShader::setFloat2(std::string const& name, glm::vec2 const& value)
{
...
void OpenGLShader::setMat3(std::string const& name, glm::mat3 const& value)
{
