...
TEST_CASE("system: SystemInfoOSName", "[system]")
{
    REQUIRE(moci::SystemInfo::getOSName() == "Linux");
}
#endif
...
TEST_CASE("system: SystemInfoOSName", "[system]")
{
    REQUIRE(moci::SystemInfo::getOSName() == "Darwin");
}
#endif
...
TEST_CASE("system: SystemInfoOSName", "[system]")
{
    REQUIRE(moci::SystemInfo::getOSName() == "Windows");
}
#endif
